...
- **Единый список устройств**: Бесшовное управление физическими и беспроводными устройствами (слияние USB/Wi-Fi) в едином представлении.
...
- **Последовательное обновление**: Более умный механизм последовательного опроса для стабильного интерфейса без мерцания.
...
- **Предварительная фильтрация (Pre-Filter)**: Высокопроизводительная буферизация, сохраняющая только те логи, которые соответствуют определенным правилам.
...
- **Функции трея**: Прямой доступ к Logcat, Shell и файловому менеджеру для закрепленных устройств прямо из трея.
- **Индикаторы записи**: Визуальный индикатор «красная точка» в трее, когда запись активна.
