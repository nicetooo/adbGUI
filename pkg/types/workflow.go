...
// This package is designed to be imported by both main and mcp packages
// to avoid type duplication and ensure consistency
package types
...
// ElementSelector defines how to locate a UI element
